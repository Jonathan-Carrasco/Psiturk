# GoldStone and Carvalho Online Replication Experiments
...
## Static
Under static you'll find a css style sheet, fonts, images, libraries used, and task.js, which is where all of the code for the experiment can be found.
